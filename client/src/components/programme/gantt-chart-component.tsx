      ...
      <CardContent>
        {tasks.length === 0 ? (
          ...
          <>
            ...
            {/* Scrollable container for entire gantt chart */}
            <div className="overflow-x-auto pb-2" style={{ maxWidth: '100%' }}>
              <div className="inline-block min-w-full">
                {/* MS Project style timeline header */}
                <div className="flex mb-2" style={{ minWidth: '1000px' }}>
                  {/* Left side - task names column */}
                  <div className="w-1/3 min-w-[300px] bg-gray-100 p-2 font-medium text-sm border-r border-gray-200 sticky left-0 z-20">
                    Task Name
                  </div>
                ...
                <div className="flex flex-col border border-gray-200 rounded-md overflow-hidden" style={{ minWidth: '1000px' }}>
                  {tasks.map((task, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-1/3 min-w-[300px] p-3 flex flex-col justify-center border-r border-gray-200 bg-white sticky left-0">
