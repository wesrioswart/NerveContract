          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="font-semibold mb-2 flex items-center gap-2">
                <Brain className="h-5 w-5 text-purple-600" />
                {uploadedFile ? 'Unified Document Analysis' : 'Combined Result'}
              </h4>
              <div className={cn(
                "p-4 rounded-lg",
                uploadedFile 
            ...
            {/* Only show individual responses for non-document analysis tasks */}
            {!uploadedFile && (
              <div>
            ...
            {/* For document analysis, show unified processing message */}
            {uploadedFile && (
              <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-green-50 p-4 rounded-lg border">
                ...
                <p className="text-sm text-purple-800">
                  All three AI models (Grok, Claude, and GPT-4o) analyzed your document simultaneously. 
