...
export const generateRfiPdf = async (req: Request, res: Response) => {
  try {
    ...
    doc.fontSize(12).font('Helvetica').text(`Contract: ${project.contractNumber || 'N/A'}`, { align: 'left' });
    doc.fontSize(12).font('Helvetica').text(`Client: ${project.client || 'N/A'}`, { align: 'left' });
    ...
    doc.fontSize(10).font('Helvetica').text(
      'Generated by NEC4 Contract Management Platform',
      50,
      doc.page.height - 50,
      { align: 'center' }
    );
